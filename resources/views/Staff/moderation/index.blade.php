                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <label for="message"></label>
                                                            <textarea title="Rejection Message" class="form-control" rows="5"
                                                                name="message" cols="50" id="message"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                ...
                <tbody>
                    @foreach ($postponed as $post)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('users.show', ['username' => $post->moderated->username]) }}" itemprop="url"
                                    class="l-breadcrumb-item-link"><span itemprop="title"
                ...
                <tbody>
                    @foreach ($rejected as $reject)
                        <tr>
                            ...
                            <td>@if ($reject->user) <a href="{{ route('users.show', ['username' => $reject->user->username]) }}"
                        ...
                        <td>
                            <a href="{{ route('users.show', ['username' => $reject->moderated->username]) }}" itemprop="url"
                                class="l-breadcrumb-item-link"><span itemprop="title"
